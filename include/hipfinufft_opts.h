// AUTO-GENERATED by tools/hipfinufft/cuda_to_hip.py from include/cufinufft_opts.h
// Do not edit by hand. Edit the CUDA source and re-run the translator.
#ifndef __HIPFINUFFT_OPTS_H__
#define __HIPFINUFFT_OPTS_H__

// python/hipfinufft/hipfinufft/_hipfinufft.py and matlab/hipfinufft.mw and
// FINUFFT.jl/src/types.jl must be kept in sync with this struct

typedef struct hipfinufft_opts { // see hipfinufft_default_opts() for defaults
